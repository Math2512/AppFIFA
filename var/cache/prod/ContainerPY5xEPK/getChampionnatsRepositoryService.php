...
// Returns the private 'App\Repository\ChampionnatsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ChampionnatsRepository.php';

return $this->privates['App\\Repository\\ChampionnatsRepository'] = new \App\Repository\ChampionnatsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
