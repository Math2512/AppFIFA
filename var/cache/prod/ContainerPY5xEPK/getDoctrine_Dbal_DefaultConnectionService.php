...
$a->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('user_image', $b, $c, $d));
$a->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('user_image', $b, $c, $d));
$a->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('user_image', $b, $c, $d));
