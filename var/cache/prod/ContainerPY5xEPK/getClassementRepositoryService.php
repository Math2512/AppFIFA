...
// Returns the private 'App\Repository\ClassementRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ClassementRepository.php';

return $this->privates['App\\Repository\\ClassementRepository'] = new \App\Repository\ClassementRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
