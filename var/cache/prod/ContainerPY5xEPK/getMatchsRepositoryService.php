...
// Returns the private 'App\Repository\MatchsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\MatchsRepository.php';

return $this->privates['App\\Repository\\MatchsRepository'] = new \App\Repository\MatchsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
