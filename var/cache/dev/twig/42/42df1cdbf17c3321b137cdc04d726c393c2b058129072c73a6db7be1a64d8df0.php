...
class __TwigTemplate_e3e5446576ea93286269cc8643eecca99d373786fc8a47abecc563722c439eec extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function block_vich_image_widget($context, array $blocks = [])
    {
        ...
        // line 26
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 26, $this->source); })()), "file", [], "any", false, false, false, 26), 'widget');
        // line 27
        if (twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "delete", [], "any", true, true, false, 27)) {
            // line 28
            echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 28, $this->source); })()), "delete", [], "any", false, false, false, 28), 'row');
        }
        // line 31
        if ((isset($context["image_uri"]) || array_key_exists("image_uri", $context) ? $context["image_uri"] : (function () { throw new RuntimeError('Variable "image_uri" does not exist.', 31, $this->source); })())) {
            // line 32
            echo "<a href=\"";
            echo twig_escape_filter($this->env, (isset($context["image_uri"]) || array_key_exists("image_uri", $context) ? $context["image_uri"] : (function () { throw new RuntimeError('Variable "image_uri" does not exist.', 32, $this->source); })()), "html", null, true);
            echo "\"><img src=\"";
            echo twig_escape_filter($this->env, (isset($context["image_uri"]) || array_key_exists("image_uri", $context) ? $context["image_uri"] : (function () { throw new RuntimeError('Variable "image_uri" does not exist.', 32, $this->source); })()), "html", null, true);
            echo "\" alt=\"\" /></a>";
        }
    ...
    public function block_vich_file_label($context, array $blocks = [])
    {
        ...
        // line 41
        $context["label"] = _twig_default_filter($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans((isset($context["label"]) || array_key_exists("label", $context) ? $context["label"] : (function () { throw new RuntimeError('Variable "label" does not exist.', 41, $this->source); })())), (isset($context["label"]) || array_key_exists("label", $context) ? $context["label"] : (function () { throw new RuntimeError('Variable "label" does not exist.', 41, $this->source); })()));
        // line 42
    ...
    {
        return array (  207 => 42,  205 => 41,  195 => 40,  185 => 37,  178 => 35,  176 => 34,  169 => 32,  167 => 31,  164 => 28,  162 => 27,  160 => 26,  158 => 25,  148 => 24,  138 => 21,  136 => 20,  126 => 19,  116 => 16,  109 => 14,  107 => 13,  104 => 10,  102 => 9,  100 => 8,  98 => 7,  88 => 6,  78 => 3,  76 => 2,  66 => 1,  56 => 40,  54 => 24,  52 => 19,  50 => 6,  48 => 1,);
    }
...
{%- block vich_file_label -%}
    ...
    {{- block('form_label') -}}
{%- endblock -%}
", "@VichUploader/Form/fields.html.twig", "C:\\wamp64\\www\\symfony\\fifa\\vendor\\vich\\uploader-bundle\\Resources\\views\\Form\\fields.html.twig");
    }
}
